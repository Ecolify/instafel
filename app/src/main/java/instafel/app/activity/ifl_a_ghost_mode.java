...
public class ifl_a_ghost_mode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ghostViewOnceSwitch.setChecked(preferenceManager.getPreferenceBoolean(PreferenceKeys.ifl_ghost_viewonce, false));
        ghostViewOnceSwitch.setOnCheckedChangeListener((buttonView, isChecked) -> {
            preferenceManager.setPreferenceBoolean(PreferenceKeys.ifl_ghost_viewonce, isChecked);
        });
        ...
        quickToggleViewOnceSwitch.setChecked(preferenceManager.getPreferenceBoolean(PreferenceKeys.ifl_quick_toggle_viewonce, false));
        quickToggleViewOnceSwitch.setOnCheckedChangeListener((buttonView, isChecked) -> {
            preferenceManager.setPreferenceBoolean(PreferenceKeys.ifl_quick_toggle_viewonce, isChecked);
        });
